...
export function DelayedItemsTable({ items, search }: { items: SolicitacaoItemWithSla[]; search: string }) {
        ...
        <table className="w-full">
          <thead className="bg-secondary border-b border-border">
            <tr>
              ...
              <th className="text-left p-4 text-xs font-semibold uppercase tracking-wider">Dias</th>
          ...
          <tbody className="divide-y divide-border">
            {pageItems.map((item) => (
              ...
              >
                ...
                <td className="p-4">
                  <Badge variant="destructive">{item.dias} dias</Badge>
                </td>
